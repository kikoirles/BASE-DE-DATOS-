...
/* CREACION DE ROLES */
/* CREACION DE ROL VENTAS */
CREATE ROLE 'rolventas';
/* CREACION DE ROL ALMACEN */
CREATE ROLE 'rolalmacen';
/* CREACION DE ROL CONTABLE */
CREATE ROLE 'rolcontable';
/* CREACION DE ROL PEDIDOS*/
CREATE ROLE 'rolpedidos';
...
/*CREACION DE USUARIOS Y AÑADIENDOLOS A SU ROL ESPECIFICADO */
...
GRANT 'rolventas' TO 'ventas'@'192.168.0.125', 'ventas'@'192.168.0.124';
...
GRANT 'rolalamcen' TO 'almacen'@'192.168.0.125', 'almacen'@'192.168.0.124';
...
GRANT 'rolcontable' TO 'contable'@'192.168.0.125', 'contable'@'192.168.0.124';
...
GRANT 'rolpedidos' TO 'pedidos'@'192.168.0.125', 'pedidos'@'192.168.0.124';

FLUSH PRIVILEGES;


/*RETIRADA DE PERMISOS DE USUARIO CONTABLE (debido a que modifico su salario) LE DENEGAMOS la modificacion y el borrado de registros */

REVOKE 'rolcontable' FROM 'contable'@'192.168.0.124';
REVOKE 'rolcontable' FROM 'contable'@'192.168.0.125';
...
/*VISTA PARA AÑADIR DATOS PORVEEDORES PAGADOS */  

CREATE VIEW VISTA_AÑADIR_PAGOS_PROVEDORES (PROVEEDORID, CANTIDADP, NOMBREPROV, TELEFONO) 
AS SELECT p.PROVEEDORID, p.CANTIDADP, po.NOMBREPROV, po.TELPROV 
FROM PAGOS p, PROVEEDORES po WHERE p.PROVEEDORID = po.PROVEEDORID; 

SELECT * FROM PCRS.VISTA_AÑADIR_PAGOS_PROVEDORES;

/*MEDIANTE LA VISTA INSERTAREMOS NUEVOS PAGOS DE PROVEEDORES (En este caso coje los siguiente valor por defecto)  */

INSERT INTO VISTA_AÑADIR_PAGOS_PROVEDORES (PROVEEDORID, CANTIDADP, NOMBREPROV, TELEFONO)
  VALUES (102,1112, 'PABLO',609785848); 
...
/*USUARIOS DEL ROL CONTABLE DERECHO A VER,INSERTAR,MODIFICAR,BORRAR REGISTROS DE LA VISTA   */
GRANT SELECT,INSERT,UPDATE,DELETE ON PCRS . VISTA_AÑADIR_PAGOS_PROVEDORES TO 'contable'@'192.168.0.124';
GRANT SELECT,INSERT,UPDATE,DELETE ON PCRS . VISTA_AÑADIR_PAGOS_PROVEDORES TO 'contable'@'192.168.0.125';
