...
GRANT SELECT, INSERT ON PCRS . ORDENES TO 'ventas'@'192.168.0.125';
GRANT SELECT, INSERT ON PCRS . CLIENTES TO 'ventas'@'192.168.0.125';
GRANT SELECT, INSERT ON PCRS . DETALLE_ORDENES TO 'ventas'@'192.168.0.125';
GRANT SELECT, INSERT ON PCRS . ORDENES TO 'ventas'@'192.168.0.124';
GRANT SELECT, INSERT ON PCRS . CLIENTES TO 'ventas'@'192.168.0.124';
GRANT SELECT, INSERT ON PCRS . DETALLE_ORDENES TO 'ventas'@'192.168.0.124';
...
GRANT SELECT, INSERT ON PCRS . PRODUCTOS TO 'almacen'@'192.168.0.124';
GRANT SELECT, INSERT ON PCRS . MARCA TO 'almacen'@'192.168.0.124';
GRANT SELECT, INSERT ON PCRS . PRODUCTOS TO 'almacen'@'192.168.0.125';
GRANT SELECT, INSERT ON PCRS . MARCA TO 'almacen'@'192.168.0.125';
...
GRANT SELECT, INSERT ON PCRS . PRODUCTOS TO 'pedidos'@'192.168.0.124';
GRANT SELECT, INSERT ON PCRS . PROVEEDORES TO 'pedidos'@'192.168.0.124';
GRANT SELECT, INSERT ON PCRS . PRODUCTOS TO 'pedidos'@'192.168.0.125';
GRANT SELECT, INSERT ON PCRS . PROVEEDORES TO 'pedidos'@'192.168.0.125';

FLUSH PRIVILEGES;

/*RETIRADA DE PERMISOS DE USUARIO CONTABLE (debido a que modifico su salario) */

REVOKE INSERT ON PCRS . PAGOS  FROM 'contable'@'192.168.0.124';
REVOKE INSERT ON PCRS . SALARIOS FROM 'contable'@'192.168.0.124';
REVOKE INSERT ON PCRS . PAGOS  FROM 'contable'@'192.168.0.125';
REVOKE INSERT ON PCRS . SALARIOS FROM 'contable'@'192.168.0.125';


/*VISTA PARA MOSTRAR A QUE EMPLEADO LA CANTIDAD DE SALIO QUE SE A REGISTADO */  
...
/*VISTA PARA MOSTRAR QUE PROEVEEDOR LA CANTIDAD DE PAGO QUE SE LE A REALIZADO QUE SE A REGISTRADO */  
...
/*ASIGNACION DE VISTAS A USURIOS */